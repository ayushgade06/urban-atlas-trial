...
export default function SellerForm() {
  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center justify-center py-10 gap-5 text-center animate-fade-up">
        ...
        <div>
          <p className="text-base font-semibold text-[#111827]">Listing submitted!</p>
          <p className="mt-1 text-sm text-[#6B7280]">We&apos;ve received your plot listing.</p>
        </div>
        <button
  ...
  return (
    <form className="space-y-4" onSubmit={submit}>
      ...
      <div>
        <label className={label} htmlFor="seller-name">Full name</label>
        <input
          id="seller-name"
          className={field}
      ...
      <div>
        <label className={label} htmlFor="seller-phone">Phone number</label>
        <input
          id="seller-phone"
          className={field}
      ...
      <div>
        <label className={label} htmlFor="seller-locality">Locality</label>
      ...
      <div>
        <label className={label} htmlFor="seller-plotsize">Plot size</label>
        <input
          id="seller-plotsize"
          className={field}
      ...
      <div>
        <label className={label} htmlFor="seller-price">Asking price</label>
        <input
          id="seller-price"
          className={field}
          placeholder="e.g. ₹85L"
